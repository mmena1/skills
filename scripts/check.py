...
TRUSTED_APPROVAL_ASSOCIATIONS = {"OWNER", "COLLABORATOR"}
...
def has_standalone_authority_record(comments: list[dict[str, str]]) -> bool:
    """Recognize complete records written by trusted human collaborators."""
    for comment in comments:
        if comment["author_association"] not in TRUSTED_APPROVAL_ASSOCIATIONS or comment["user_type"] != "User":
            continue
...
def validate_implementation_authority_contract() -> None:
    ...
    required_contract_text = (
        ...
        (triage, "trusted GitHub association"),
    ...
    owner_comment = {"body": approved_body, "author_association": "OWNER", "user_type": "User"}
    collaborator_comment = {"body": approved_body, "author_association": "COLLABORATOR", "user_type": "User"}
    untrusted_comment = {"body": approved_body, "author_association": "CONTRIBUTOR", "user_type": "User"}
    bot_comment = {"body": approved_body, "author_association": "OWNER", "user_type": "Bot"}
    triage_comment = {"body": triage_body, "author_association": "OWNER", "user_type": "User"}
    ...
    if resolve_issue_authority(parent=None, comments=[untrusted_comment]) is not None:
        fail("standalone authority record from an untrusted commenter was accepted")
