...
The issue tracker and triage label vocabulary should have been provided to you. Require `docs/agents/issue-tracker.md` to define implementation-ready and planned states, canonical blocker checks, and frontier promotion. If the file is missing or predates that contract, tell the user to run `/setup-matt-pocock-skills` to configure or migrate it, then stop.
